...
Running the Program
------------------------------------------------------------------------------------------------------
To run the program, simply double click on the "Remember Me.jar" file. 

Warning: Do not move, delete, duplicate, or modify any of the files within this directory. Doing
	 so may make it impossible for the program to work.
...
and edit or delete entries easily. When searching for entries, names will automatically be sorted 
alphabetically.
